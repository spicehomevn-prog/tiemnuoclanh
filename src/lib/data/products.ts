...
export const toppings: Topping[] = [
  // Trân châu
  { id: 'tran-chau-dua',                   name: { vi: 'Trân Châu Dừa',                             en: 'Coconut Pearls'                        }, price: 8000,  imageSrc: '/images/products/tran-chau-dua-non.JPG'                   },
  { id: 'tran-chau-dua-la-dua',            name: { vi: 'Trân Châu Dừa Lá Dứa',                       en: 'Pandan Coconut Pearls'                 }, price: 8000,  imageSrc: '/images/products/tran-chau-dua-non-la-dua.JPG'            },
  { id: 'tran-chau-dua-thanh-long-do',     name: { vi: 'Trân Châu Dừa Thanh Long Đỏ',                en: 'Red Dragon Fruit Coconut Pearls'       }, price: 8000,  imageSrc: '/images/products/tran-chau-dua-thanh-long-do.JPG'         },
  { id: 'tran-chau-cu-nang',               name: { vi: 'Trân Châu Củ Năng',                           en: 'Water Chestnut Pearls'                 }, price: 8000,  imageSrc: '/images/products/tran-chau-cu-nang.JPG'                   },
  { id: 'tran-chau-cu-nang-thanh-long-do', name: { vi: 'Trân Châu Củ Năng Thanh Long Đỏ',            en: 'Red Dragon Fruit Water Chestnut Pearls'}, price: 8000,  imageSrc: '/images/products/tran-chau-cu-nang-thanh-long-do.JPG'    },
  // Thạch
  { id: 'thach-dua-tuoi',                  name: { vi: 'Thạch Dừa Tươi',                              en: 'Fresh Coconut Jelly'                   }, price: 8000,  imageSrc: '/images/products/thach-dua-tuoi.JPG'                      },
  { id: 'thach-la-dua',                    name: { vi: 'Thạch Lá Dứa',                                 en: 'Pandan Jelly'                          }, price: 8000,  imageSrc: '/images/products/thach-la-dua.JPG'                        },
  { id: 'thach-thanh-long-do',             name: { vi: 'Thạch Thanh Long Đỏ',                          en: 'Red Dragon Fruit Jelly'                }, price: 8000,  imageSrc: '/images/products/thach-thanh-long.JPG'                    },
  { id: 'mix-3-loai-thach',               name: { vi: 'Mix 3 Loại Thạch (Thanh Long, Lá Dứa, Dừa)',  en: 'Mix 3 Jellies (Dragon Fruit, Pandan, Coconut)' }, price: 15000, imageSrc: '/images/products/mix-3-thach.jpg'              },
  // Hạt
  { id: 'hat-dac-rim-thot-not',            name: { vi: 'Hạt Đác Rim Thốt Nốt',                        en: 'Palm Seeds in Palm Sugar'              }, price: 10000, imageSrc: null                                                       },
]
...
export const products: Product[] = [
  // ── RAU MÁ ──────────────────────────────────────────────────────────────────
  {
    ...
    price: 16000, categoryId: 'rau-ma', swatch: '#E3E9DD', imageSrc: '/images/products/rau-ma-truyen-thong.JPG', imagePosition: 'top 20%',
  },
  {
    id: 'rau-ma-dua',
    ...
    price: 25000, categoryId: 'rau-ma', swatch: '#E3E9DD', imageSrc: '/images/products/rau-ma-dua-tuoi.JPG', imagePosition: 'top 20%',
  },
  {
    id: 'rau-ma-dau-xanh',
    ...
    price: 25000, categoryId: 'rau-ma', swatch: '#E3E9DD', imageSrc: '/images/products/rau-ma-dau-xanh.JPG',
  },
  {
    id: 'rau-ma-sua-dua',
  ...
  },
  {
    ...
    price: 30000, categoryId: 'rau-ma', signature: true, swatch: '#E3E9DD', imageSrc: '/images/products/rau-ma-dau-xanh-sua-dua.JPG',
  },
  {
  ...
  // ── CÀ PHÊ ──────────────────────────────────────────────────────────────────
  {
    ...
    price: 18000, categoryId: 'ca-phe', swatch: '#D9CBAF', imageSrc: '/images/products/ca-phe-den.jpg',
  },
  {
    id: 'ca-phe-sua',
  ...
  // ── TRÀ TRÁI CÂY ────────────────────────────────────────────────────────────
  {
    ...
    price: 25000, categoryId: 'tra-trai-cay', swatch: '#F5E6C8', imageSrc: '/images/products/tra-tac-tran-chau-dua-non.JPG',
  },
  {
    ...
    price: 25000, categoryId: 'tra-trai-cay', swatch: '#F5E6C8', imageSrc: null,
  },
  {
